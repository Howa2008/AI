  ...
  return (
    <footer className="bg-gray-900 text-white py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link to="/tasks" className="text-gray-400 hover:text-white transition">
                  Tasks
                </Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li>
                <Link to="/tutorials" className="text-gray-400 hover:text-white transition">
                  Tutorials
                </Link>
              </li>
              <li>
                <Link to="/api-reference" className="text-gray-400 hover:text-white transition">
                  API Reference
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center md:flex md:items-center md:justify-between">
          <div className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} Omnia AI. All rights reserved.
          </div>
